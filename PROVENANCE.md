...
| Beyond the 2MRS range | First-party `js/cosmic-web.js`, informed by the Voronoi-foam hierarchy described by van de Weygaert & Icke 1989, A&A 213, 1 | A fixed-seed 6,500-point Voronoi-proximity density illustration occupies a non-overlapping shell outside the 300 Mpc 2MRS display boundary and supplies continuity toward the CMB. It is not observed galaxies, a survey reconstruction, a named structure map, or a cosmological simulation. It contains no invented connections. Total post-Virgo density is 49,427 samples in two point draws, plus one seven-point cluster-anchor draw. |
...
| `docs/assets/*.webp` | Screenshots rendered from Helios for repository documentation. The post-Virgo, web, and universe stills are exact `v2026.8.23a` [Audit #131](https://github.com/XenoVoyage/Helios/actions/runs/32605911039) renders; the remaining screenshots preserve earlier visual checkpoints and are not a claim of pixel identity with the current candidate. | Family manifest: `f9c254eb425b018bbecf238f944dc64d2bef555dd283a34757a9b2a0fdccfbcc` |
