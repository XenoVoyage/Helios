...
| `docs/assets/*.webp` | Screenshots rendered from Helios for repository documentation. `helios-local-group.webp`, `helios-virgo.webp`, `helios-preweb.webp`, `helios-web.webp`, and `helios-universe.webp` are derived from the `1440×900` PNG evidence for exact runtime candidate `8ff977ea` in [Audit #143](https://github.com/XenoVoyage/Helios/actions/runs/32658237548), converted without resizing to lossy VP8 WebP with FFmpeg/libwebp (`quality 70`, compression level 6, `picture` preset). The remaining screenshots preserve earlier visual checkpoints and are not a claim of pixel identity with the current candidate. | Family manifest: `d80ab44e39d3f597386523c7c6787fe9745a41548f110661035d596bf37afc9b` |
