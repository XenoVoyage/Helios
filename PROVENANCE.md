...
| Outer cosmological scale | [Planck 2018 VI](https://arxiv.org/abs/1807.06209) | The particle-horizon display uses about 46.5 Gly / 14.25 Gpc. The physical last-scattering surface is distinct; the illustrative CMB sphere is deliberately co-located with the outer display radius. Seeing that sphere “from outside” is a camera/scale metaphor. The low-opacity CMB texture and additive radial rim are readability layers, not a literal observable-universe edge. |
