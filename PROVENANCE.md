...
Sources were last checked on 2026-08-22. Hashes are SHA-256 of the tracked
local files.
...
| `docs/assets/*.webp` | Screenshots rendered from Helios for repository documentation. The post-Virgo, web, and universe stills are candidate `v2026.8.22a` CI renders; the remaining screenshots preserve earlier visual checkpoints and are not a claim of pixel identity with the current candidate. | Family manifest: `2cb5271aeeb7fbde77242d48b80af0c8ca703789937fa555921742998a840754` |
