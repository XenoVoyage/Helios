...
[![Version v2026.9.10a](https://img.shields.io/badge/version-v2026.9.10a-66f7ff)](VERSION.txt)
...
Open **Camera** for orbit and zoom buttons that work with a click, tap, or keyboard. With the scene focused, use the arrow keys to orbit, **I** to zoom in, and **O** to zoom out; hold a key to repeat. **Space** pauses time, **+ / −** change time speed, and **Escape** resets the view. Camera commands preserve the same globe safety, zoom limits, and scale transitions as drag, wheel, and pinch. The fixed `?look=sky` diagnostic view has no camera navigation.
