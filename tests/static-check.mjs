...
await stat(path.join(root, "docs/assets/helios-superclusters.webp"));
...
assert.match(await read("README.md"), /docs\/assets\/helios-superclusters\.webp/);
