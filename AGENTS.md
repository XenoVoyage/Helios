...
3. Preserve published NASA / JPL / IAU / SIMBAD values. Only the visual scale, the galaxy kpc mapping, and the time slider are allowed to diverge from 1:1.
...
| Galactic neighborhood | `js/galaxy.js`, `js/galaxy-catalog.js` |
